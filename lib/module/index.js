...
const DeviceCrypto = {
   ...
   * @return {Promise} Resolves to encrypted text `Base64` formatted
   */
  async encryptSymmetricallyWithPassword(passwordBase64, saltBase64, iterations, payloadBase64) {
   ...
   */
  async decryptSymmetricallyWithPassword(passwordBase64, saltBase64, ivBase64, iterations, cipherTextBase64) {
