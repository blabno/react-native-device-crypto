...
declare const DeviceCrypto: {
     ...
     * @return {Promise} Resolves to encrypted text `Base64` formatted
     */
    encryptSymmetricallyWithPasswordAndSalt(passwordBase64: string, saltBase64: string, iterations: number, payloadBase64: string): Promise<EncryptionResult>;
    /**
     ...
     */
    decryptSymmetricallyWithPasswordAndSalt(passwordBase64: string, saltBase64: string, ivBase64: string, iterations: number, cipherTextBase64: string): Promise<string>;
    /**
